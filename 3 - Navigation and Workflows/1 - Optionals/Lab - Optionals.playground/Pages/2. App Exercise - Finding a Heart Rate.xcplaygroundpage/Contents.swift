...
print("Heart Rate: \(String(describing: heartRate))")
...
var hrSum = oldHR1 + oldHR2 + oldHR3 + oldHR4


if let currentHR = heartRate {
    hrSum += currentHR
    
    let count = heartRate != nil ? 5 : 4
    let hrAverage = hrSum / count
    print("Average Heart Rate: \(hrAverage)")
} else {
    print("Heart rate information is incomplete.")
}
