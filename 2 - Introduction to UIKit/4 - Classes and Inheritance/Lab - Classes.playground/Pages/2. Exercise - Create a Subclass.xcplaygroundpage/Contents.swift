...
destroyer.moveRight()
print("Updated Position after moveRight(): \(destroyer.position)")
...
// Attempt to print the weapon property on falcon
// Uncommenting the following line will result in a compilation error:
// print("Weapon on falcon: \(falcon.weapon)")

// Explanation:
// The 'weapon' property is specific to the Fighter subclass, and falcon is an instance of the Spaceship class,
// which does not have a 'weapon' property. Therefore, trying to access 'weapon' on falcon will result in a compilation error.
