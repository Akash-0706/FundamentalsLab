...
falcon.moveLeft()
print("New Position after moving left: \(falcon.position)")

falcon.moveLeft()
print("New Position after moving left again: \(falcon.position)")

// Move falcon to the right once and print the new position
falcon.moveRight()
print("New Position after moving right: \(falcon.position)")
...
// Call wasHit() on falcon and print the updated health
falcon.wasHit()
print("Health after being hit: \(falcon.health)")
/*:
