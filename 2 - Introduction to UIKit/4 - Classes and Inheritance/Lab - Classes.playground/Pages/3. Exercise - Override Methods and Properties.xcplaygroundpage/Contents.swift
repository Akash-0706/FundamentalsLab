...
class ShieldedShip: Fighter {
    ...
    override func wasHit() {
           if shieldStrength > 0 {
               ...
               super.wasHit() // Call the base class's wasHit() if shieldStrength is depleted
           }
       }
}
...
defender.moveRight()
print("Position after moveRight(): \(defender.position)")


defender.fire()
print("Remaining Fire Power after fire(): \(defender.remainingFirePower)")
...
defender.wasHit()
print("Shield Strength after wasHit(): \(defender.shieldStrength)")
print("Health after wasHit(): \(defender.health)")
