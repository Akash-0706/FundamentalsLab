...
let favoriteBook = Book(title: "To Kill a Mockingbird", author: "Harper Lee", pages: 281, price: 9.99)
...
let laptop2 = Laptop(screenSize: 13, repairCount: 1, yearPurchased: 2022)
