...
struct User {
    ...
    static var currentUser: User = User(userName: "YourUserName", email: "your@example.com", age: 25)
 ...
 */
let anotherUser = User(userName: "AnotherUser", email: "another@example.com", age: 30)
