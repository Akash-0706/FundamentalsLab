...
var myRunningWorkout = RunningWorkout()
myRunningWorkout.distance = 5.0 // in miles
myRunningWorkout.time = 30.0 // in minutes
myRunningWorkout.elevation = 100.0 // in feet

print("Running Workout - Distance: \(myRunningWorkout.distance) miles, Time: \(myRunningWorkout.time) minutes, Elevation: \(myRunningWorkout.elevation) feet")
...
print("First Run - Distance: \(firstRun.distance) miles, Time: \(firstRun.time) minutes, Elevation: \(firstRun.elevation) feet")
...
firstRun.distance = 2396.0 // in meters
firstRun.time = 15.3 // in minutes
firstRun.elevation = 94.0 // in meters


print("First Run - Distance: \(firstRun.distance) meters, Time: \(firstRun.time) minutes, Elevation: \(firstRun.elevation) meters")
