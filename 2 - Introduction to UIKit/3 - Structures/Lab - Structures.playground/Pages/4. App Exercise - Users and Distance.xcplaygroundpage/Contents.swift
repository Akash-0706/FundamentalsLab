...
var myself = User(name: "John", age: 30, height: 175.0, weight: 70.5, activityLevel: 7)

print("User Information:")
print("Name: \(myself.name)")
print("Age: \(myself.age)")
print("Height: \(myself.height) cm")
print("Weight: \(myself.weight) kg")
print("Activity Level: \(myself.activityLevel) out of 10")
/*:
...
print("Distance in meters: \(distanceInMeters.meters)")
print("Distance in feet: \(distanceInMeters.feet)")

let distanceInFeet = Distance(feet: 5249.344)
print("Distance in meters: \(distanceInFeet.meters)")
print("Distance in feet: \(distanceInFeet.feet)")
...
let anotherDistance = Distance(feet: 10000)
