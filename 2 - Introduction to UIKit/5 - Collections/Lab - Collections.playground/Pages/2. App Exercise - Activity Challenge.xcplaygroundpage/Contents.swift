 ...
 */
var walkingChallenges: [String] = ["Walk 3 miles a day", "Take 10,000 steps daily"]


var runningChallenges: [String] = ["Run 5 times a week", "Run a half marathon"]

var calisthenicsChallenges: [String] = ["Complete 100 push-ups", "Do a 5-minute plank"]
var weightliftingChallenges: [String] = ["Lift your body weight in squats", "Bench press 1.5 times your body weight"]
...
if challenges.count > 1 && challenges[1].count > 0 {
    let firstChallengeInRunning = challenges[1][0]
    print("First challenge in the Running Challenges: \(firstChallengeInRunning)")
} else {
    print("There is no second challenge list or it is empty.")
}
//:  All of the challenges will reset at the end of the month. Use the `removeAll` to remove everything from `challenges`. Print `challenges`.
challenges.removeAll()

print("Challenges after removeAll: \(challenges)")
...
var userCommittedChallenges: [String] = ["Walk 3 miles a day", "Run a half marathon"]


print("User-Committed Challenges: \(userCommittedChallenges)")
//:  Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
if userCommittedChallenges.isEmpty {
    print("It looks like you haven't committed to any challenges yet. Please commit to a challenge!")
} else if userCommittedChallenges.count == 1 {
    print("The challenge you have chosen is \(userCommittedChallenges[0])")
} else {
