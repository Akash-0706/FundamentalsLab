 ...
 */
var friend = 250
print("numbers of friends on social media \(friend)")
...
friend = 200
print("After removing inactive friends, the updated count is: \(friend)")
...
friends = 200
print("After removing inactive friends, the updated count is: \(friends)")
